...
export const NIVELES = [
  {
    ...
    pregunta: '¿Qué experiencia quieres descubrir primero?',
    opciones: [
      {
        id:             'bronze_muestras_coreanas',
        emoji:          '🎁',
        label:          'Kit de Muestras Selección Coreana',
      ...
      },
      {
        id:             'bronze_vip',
        emoji:          '✨',
        label:          'Acceso VIP Moonbow',
        desc:           'Acceso anticipado a lanzamientos exclusivos',
        tipo:           'experiencia',
        codigo_shopify: null,
        valor_estimado: 12000,
      },
  ...
  },
  {
    ...
    pregunta: '¿Qué sorpresa prefieres descubrir?',
    opciones: [
      {
        id:             'silver_mini',
        emoji:          '🎁',
        label:          'Mini Producto Viral (Sorpresa)',
      ...
      },
      {
        ...
        desc:           'Armado con tu diagnóstico — producto exclusivo',
        tipo:           'kit',
        codigo_shopify: null,
        valor_estimado: 12000,
      },
  ...
  },
  {
    ...
    pregunta: '¿Cuál experiencia exclusiva prefieres?',
    opciones: [
      {
        id:               'gold_moonbow_box',
        emoji:            '🎁',
        label:            'Moonbow Box Exclusiva',
        desc:             'Kit Full-Size — no disponible en tienda',
        tipo:             'producto',
        codigo_shopify:   null,
        valor_estimado:   15000,
        requiere_skin_ia: true, // personalizar con Analizador de Piel
      },
      {
        id:               'gold_rutina_ia',
        emoji:            '✨',
        label:            'Rutina IA Personalizada',
        desc:             'Producto exclusivo armado con tu diagnóstico de piel',
        tipo:             'kit',
        codigo_shopify:   null,
        valor_estimado:   15000,
